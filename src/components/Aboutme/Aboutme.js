...
const Aboutme = () => {
	return(
		<div className="color" id="aboutme">
			<div className="container-fluid  pa4">
						<div className="d-flex flex-column bd-highlight mb3">
						  <div className="p-2 bd-highlight tc b headeraboutme fontfam">Yash Patel</div>
						  <div className="p-2 bd-highlight tc i headerme about pa0">AboutMe</div>
						</div>
