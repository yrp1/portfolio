	...
	return(
		<div>
			<div className="container">
					  ...
					  <div className="  bd-highlight  "><img className="yash pa3 br3 shadow-2"alt="img"src={yrp}/></div>
					  <div className="p-2 bd-highlight text"><strong>Hey, I'm Yash Patel, frontend developer. 
